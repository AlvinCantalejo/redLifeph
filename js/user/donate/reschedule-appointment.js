...
function bindActionButtons(){
    ...
    $("#confirm-appointment").on("click", function(){
        ...
        appointmentData.id = CookieClass.getCookie(Appointment.ID_APPOINTMENT);
...
function rescheduleAppointment(appointment){
    ...
    var endpoint = "user/reschedule-appointment";
...
function displayConfirmationModal(reasons="", type){
    ...
    switch(type){
        case "success":
            title = "Appointment is rescheduled successfully";
            icon = "bi bi-check2-circle";
            iconStyle = "font-size: 4rem; color: green";
            message = "<b>Thank you!</b> <br>Your appointment is rescheduled successfully.<br> Please expect an email shortly.";
        break;

        case "failed-eligibility":
            title = "Appointment rescheduling unsuccessful";
            icon = "bi bi-x-circle";
            iconStyle = "font-size: 4rem; color: red";
            message = "<b>Thank you for your interest in donating.</b> <br>"
                            +"Unfortunately, we cannot proceed with your <br> rescheduling because of the following reasons: </br></br><em>"

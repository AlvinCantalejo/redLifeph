...
<footer class="p-5 text-white footer-background">
  <div class="row mt-5">
    <div class="text-center mt-5">
      ...
      <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="learn.php">Donate</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white" href="request.php">Request</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white" href="drives.php">Mobile Donation</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white" href="learn.php">Learn</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="text-center justify-content-between border-top">
    ...
    <div class="col-12">
      <a href="https://www.facebook.com/redcrossdasma"><img src="./res/img/fb-logo.png"></a>
      <a href="mailto:cavitedasmarinas@redcross.org.ph"><img src="./res/img/email-logo.png"></a>
    </div>
  </div>
</footer>

      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="./res/img/main-bg-1.jpeg" class="carousel-image-1" style="z-index: 0" alt="carousel-image">
          ...
          <div class="carousel-item">
            <img src="./res/img/main-bg-2.jpg" class="carousel-image-1" style="z-index: 0" alt="carousel-image">
            <div class="color-overlay"></div>
            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-lg btn-danger" href="learn.php">Learn more</a></p>
              </div>
            </div>
          </div>

          <div class="carousel-item">
            <img src="./res/img/main-bg-3.jpg" class="carousel-image-1" style="z-index: 0" alt="carousel-image">
		        <div class="color-overlay"></div>
            <div class="container">
              <div class="carousel-caption text-end">
                <h1>Mobile Blood Donation.</h1>
                <p>Join our blood letting activities in your convenient place.</p>
                <p><a class="btn btn-lg btn-danger" href="drives.php">Browse Mobile Donation</a></p>
              </div>
            </div>
          </div>
      ...
      <div class="container buttons">
        <div class="row">
          <div class="col-lg-3">
            ...
            <p><a class="btn btn-outline-danger" href="donate.php">Donate &raquo;</a></p>
          ...
          <div class="col-lg-3">
            ...
            <p><a class="btn btn-outline-danger btn-request" href="request.php">Request &raquo;</a></p>
            
          </div>
          <div class="col-lg-3">
            <img src="./res/img/campaignLogo.png" class="logo" alt="campaign-logo" id="btn-campaign" name="btn-campaign"><br><br>
            <p>Browse mobile blood donation near you</p>
            <p><a class="btn btn-outline-danger btn-drives" href="drives.php">Mobile Donation &raquo;</a></p>
          ...
          <div class="col-lg-3">
            ...
            <p><a class="btn btn-outline-danger btn-learn" href="learn.php">Learn &raquo;</a></p>
          </div>
        </div>
      </div>
	  </br> </br>

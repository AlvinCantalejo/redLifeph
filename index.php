    ...
    <div class="header" id="myHeader" style="z-index: 1"> 
		...
		<section id ="signedOut">
			<div class="header-right">
				<img src="resources/images/loginIcon.png" class="loginIcon" alt="loginIcon">
				<div class="LoginLink">
					<a href ="login-page.html" class="LoginPage">Login</a>
				</div>
			</div>
		</section>
	...
	<div class="content" style="z-index: 0">
		...
		<div class="logo-alignment">
			<div class="row">
				...
				<div class="col-md-2">
					<img src="resources/images/donateLogo.png" class="logo" alt="donateLogo" onclick="window.location.href='login-page.html'"><br>
					<div class="buttonTitle">Donate</div>
					<div class="buttonSubtitle">Make appointment now!</div>
				</div>

				<div class="col-md-2">
					<img src="resources/images/requestLogo.png" class="logo" alt="requestLogo"><br>
					<div class="buttonTitle">Request</div>
					<div class="buttonSubtitle">Schedule request for blood products</div>
				</div>

				<div class="col-md-2">
					<img src="resources/images/campaignLogo.png" class="logo" alt="campaignLogo"><br>
					<div class="buttonTitle">Campaign</div>
					<div class="buttonSubtitle">Browse blood donation campaign near you</div>
				</div>

				<div class="col-md-2">
					<img src="resources/images/learnLogo.png" class="logo" alt="learnLogo"><br>
